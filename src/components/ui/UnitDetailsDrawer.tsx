      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-neutral-800">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 rounded hover:bg-neutral-800 transition-colors cursor-pointer"
          >
            <X size={20} />
          </button>
        </div>
          ...
          {unit && !isLoading && !error && (
            <div className="space-y-4 animate-fade-in">
              <div>
                ...
                <p
                  className={`w-fit px-2 py-0.5 rounded-full text-sm ${getTypeColor(unit.type)}`}
                >
              ...
              <div className="text-sm text-gray-300 space-y-1">
                <p>
                  <span className="text-gray-400">ID:</span> {unit.id}
                </p>
                {unit.lastUpdated && (
                  <p>
              ...
              <div className="pt-2 border-t border-neutral-800">
                <p className="text-xs text-gray-500">
                  More attributes can be displayed here.
                </p>
              </div>
            </div>
          )}
